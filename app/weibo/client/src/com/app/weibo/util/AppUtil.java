...
import com.app.weibo.base.BaseModel;
...
public class AppUtil {
	...
	public static SharedPreferences getSharedPreferences (Context ctx) {
		return ctx.getSharedPreferences("com.app.weibo.sp.global", Context.MODE_PRIVATE);
	}
	
	public static SharedPreferences getSharedPreferences (Service service) {
		return service.getSharedPreferences("com.app.weibo.sp.global", Context.MODE_PRIVATE);
	}
