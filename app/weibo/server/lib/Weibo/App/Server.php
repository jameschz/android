 ...
 * @package Weibo_App
 */
class Weibo_App_Server extends Hush_Service
{
	/**
	 * @var array
	 */
	...
	public function __init ()
	{
		...
		$this->dao = new Weibo_Dao();
		
		// init url
		require_once 'Weibo/Util/Url.php';
		$this->url = new Weibo_Util_Url();
		
		// init session
		require_once 'Weibo/Util/Session.php';
		$this->session = new Weibo_Util_Session();
	}
